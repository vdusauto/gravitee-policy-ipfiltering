...
public class IPFilteringPolicyTest {
    ...
    public void shouldFailCausedIpInBlacklist() {
        when(mockConfiguration.getBlacklistIps()).thenReturn(Arrays.asList(new IpOrCIDRBlock("192.168.0.1"), new IpOrCIDRBlock("192.168.0.2"), new IpOrCIDRBlock("192.168.0.3")));
    ...
    public void shouldFailCausedIpNotInWhitelist() {
        when(mockConfiguration.getWhitelistIps()).thenReturn(Arrays.asList(new IpOrCIDRBlock("192.168.0.1"), new IpOrCIDRBlock("192.168.0.2"), new IpOrCIDRBlock("192.168.0.3")));
    ...
    public void shouldFailCausedIpInBlacklistAndNotInWhitelist() {
        when(mockConfiguration.getBlacklistIps()).thenReturn(Arrays.asList(new IpOrCIDRBlock("192.168.0.1"), new IpOrCIDRBlock("192.168.0.2"), new IpOrCIDRBlock("192.168.0.3")));
        when(mockConfiguration.getWhitelistIps()).thenReturn(Arrays.asList(new IpOrCIDRBlock("192.168.0.4"), new IpOrCIDRBlock("192.168.0.5"), new IpOrCIDRBlock("192.168.0.6")));
        when(mockRequest.remoteAddress()).thenReturn("192.168.0.1");
        when(mockRequest.headers()).thenReturn(new HttpHeaders());
        IPFilteringPolicy policy = new IPFilteringPolicy(mockConfiguration);
